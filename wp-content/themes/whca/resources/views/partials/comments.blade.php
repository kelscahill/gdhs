...
<section id="c-comments" class="comments">
  @if (have_comments())
    <h2>
      ...
      <nav>
        <ul class="c-pager">
          @if (get_previous_comments_link())
            <li class="o-previous">@php(previous_comments_link(__('&larr; Older comments', 'sage')))</li>
          @endif
          @if (get_next_comments_link())
            <li class="o-next">@php(next_comments_link(__('Newer comments &rarr;', 'sage')))</li>
          @endif
        </ul>
      </nav>
    @endif
